...
internal class DatabaseService : IDatabaseService
{
    ...
    private readonly ConcurrentDictionary<string, Func<IDbConnection>> _connectionStrings = new();
    ...
    {
        return NativeDatabase.ConnectionExists(connectionName)
            ? NativeDatabase.GetCredentials(connectionName)
            : NativeDatabase.GetDefaultConnectionCredentials();
    }
