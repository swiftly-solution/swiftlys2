...
internal class CWorkshop_PopulateItemDescriptions_Request_ItemDescriptionsLanguageBlockImpl : TypedProtobuf<CWorkshop_PopulateItemDescriptions_Request_ItemDescriptionsLanguageBlock>, CWorkshop_PopulateItemDescriptions_Request_ItemDescriptionsLanguageBlock
{
    ...
    public string Language { get => Accessor.GetString("language"); set => Accessor.SetString("language", value); }


    public IProtobufRepeatedFieldSubMessageType<CWorkshop_PopulateItemDescriptions_Request_SingleItemDescription> Descriptions { get => new ProtobufRepeatedFieldSubMessageType<CWorkshop_PopulateItemDescriptions_Request_SingleItemDescription>(Accessor, "descriptions"); }
