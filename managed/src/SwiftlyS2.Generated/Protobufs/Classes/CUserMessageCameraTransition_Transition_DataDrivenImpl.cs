...
internal class CUserMessageCameraTransition_Transition_DataDrivenImpl : TypedProtobuf<CUserMessageCameraTransition_Transition_DataDriven>, CUserMessageCameraTransition_Transition_DataDriven
{
    ...
    public string Filename { get => Accessor.GetString("filename"); set => Accessor.SetString("filename", value); }


    public int AttachEntIndex { get => Accessor.GetInt32("attach_ent_index"); set => Accessor.SetInt32("attach_ent_index", value); }
