...
internal class CMsgGCCStrike15_v2_AccountPrivacySettings_SettingImpl : TypedProtobuf<CMsgGCCStrike15_v2_AccountPrivacySettings_Setting>, CMsgGCCStrike15_v2_AccountPrivacySettings_Setting
{
    ...
    public uint SettingType { get => Accessor.GetUInt32("setting_type"); set => Accessor.SetUInt32("setting_type", value); }


    public uint SettingValue { get => Accessor.GetUInt32("setting_value"); set => Accessor.SetUInt32("setting_value", value); }
