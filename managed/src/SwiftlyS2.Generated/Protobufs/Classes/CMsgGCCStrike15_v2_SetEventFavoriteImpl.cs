...
internal class CMsgGCCStrike15_v2_SetEventFavoriteImpl : TypedProtobuf<CMsgGCCStrike15_v2_SetEventFavorite>, CMsgGCCStrike15_v2_SetEventFavorite
{
    ...
    public ulong Eventid { get => Accessor.GetUInt64("eventid"); set => Accessor.SetUInt64("eventid", value); }


    public bool IsFavorite { get => Accessor.GetBool("is_favorite"); set => Accessor.SetBool("is_favorite", value); }
