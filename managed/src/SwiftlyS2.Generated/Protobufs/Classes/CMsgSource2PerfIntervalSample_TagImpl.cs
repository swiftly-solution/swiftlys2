...
internal class CMsgSource2PerfIntervalSample_TagImpl : TypedProtobuf<CMsgSource2PerfIntervalSample_Tag>, CMsgSource2PerfIntervalSample_Tag
{
    ...
    public string Tag { get => Accessor.GetString("tag"); set => Accessor.SetString("tag", value); }


    public uint MaxValue { get => Accessor.GetUInt32("max_value"); set => Accessor.SetUInt32("max_value", value); }
