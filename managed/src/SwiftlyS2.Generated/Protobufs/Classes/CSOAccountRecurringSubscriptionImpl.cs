...
internal class CSOAccountRecurringSubscriptionImpl : TypedProtobuf<CSOAccountRecurringSubscription>, CSOAccountRecurringSubscription
{
    ...
    public uint TimeNextCycle { get => Accessor.GetUInt32("time_next_cycle"); set => Accessor.SetUInt32("time_next_cycle", value); }


    public uint TimeInitiated { get => Accessor.GetUInt32("time_initiated"); set => Accessor.SetUInt32("time_initiated", value); }
