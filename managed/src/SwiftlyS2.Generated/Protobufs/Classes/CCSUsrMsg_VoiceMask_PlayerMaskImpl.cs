...
internal class CCSUsrMsg_VoiceMask_PlayerMaskImpl : TypedProtobuf<CCSUsrMsg_VoiceMask_PlayerMask>, CCSUsrMsg_VoiceMask_PlayerMask
{
    ...
    public int GameRulesMask { get => Accessor.GetInt32("game_rules_mask"); set => Accessor.SetInt32("game_rules_mask", value); }


    public int BanMasks { get => Accessor.GetInt32("ban_masks"); set => Accessor.SetInt32("ban_masks", value); }
