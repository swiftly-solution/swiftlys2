...
internal class CPublishedFile_Unsubscribe_RequestImpl : TypedProtobuf<CPublishedFile_Unsubscribe_Request>, CPublishedFile_Unsubscribe_Request
{
    public CPublishedFile_Unsubscribe_RequestImpl(nint handle, bool isManuallyAllocated) : base(handle)
    {
    }
