...
internal class CMsgVDebugGameSessionIDEventImpl : NetMessage<CMsgVDebugGameSessionIDEvent>, CMsgVDebugGameSessionIDEvent
{
    ...
    public int Clientid { get => Accessor.GetInt32("clientid"); set => Accessor.SetInt32("clientid", value); }


    public string Gamesessionid { get => Accessor.GetString("gamesessionid"); set => Accessor.SetString("gamesessionid", value); }
