...
internal class CMsgSosSetLibraryStackFieldsImpl : NetMessage<CMsgSosSetLibraryStackFields>, CMsgSosSetLibraryStackFields
{
    ...
    public uint StackHash { get => Accessor.GetUInt32("stack_hash"); set => Accessor.SetUInt32("stack_hash", value); }


    public byte[] PackedFields { get => Accessor.GetBytes("packed_fields"); set => Accessor.SetBytes("packed_fields", value); }
