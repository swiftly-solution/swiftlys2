...
internal class ScoreLeaderboardData_EntryImpl : TypedProtobuf<ScoreLeaderboardData_Entry>, ScoreLeaderboardData_Entry
{
    ...
    public uint Tag { get => Accessor.GetUInt32("tag"); set => Accessor.SetUInt32("tag", value); }


    public uint Val { get => Accessor.GetUInt32("val"); set => Accessor.SetUInt32("val", value); }
