...
internal class CQuest_PublisherAddCommunityItemsToPlayer_ResponseImpl : TypedProtobuf<CQuest_PublisherAddCommunityItemsToPlayer_Response>, CQuest_PublisherAddCommunityItemsToPlayer_Response
{
    ...
    public uint ItemsMatched { get => Accessor.GetUInt32("items_matched"); set => Accessor.SetUInt32("items_matched", value); }


    public uint ItemsGranted { get => Accessor.GetUInt32("items_granted"); set => Accessor.SetUInt32("items_granted", value); }
