...
internal class CMsgGCCStrike15_ClientDeepStats_DeepStatsMatchImpl : TypedProtobuf<CMsgGCCStrike15_ClientDeepStats_DeepStatsMatch>, CMsgGCCStrike15_ClientDeepStats_DeepStatsMatch
{
    ...
    public DeepPlayerStatsEntry Player { get => new DeepPlayerStatsEntryImpl(NativeNetMessages.GetNestedMessage(Address, "player"), false); }


    public IProtobufRepeatedFieldSubMessageType<DeepPlayerMatchEvent> Events { get => new ProtobufRepeatedFieldSubMessageType<DeepPlayerMatchEvent>(Accessor, "events"); }
