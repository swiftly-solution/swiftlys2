...
internal class CMsgGCToGCDirtyMultipleSDOCacheImpl : TypedProtobuf<CMsgGCToGCDirtyMultipleSDOCache>, CMsgGCToGCDirtyMultipleSDOCache
{
    ...
    public uint SdoType { get => Accessor.GetUInt32("sdo_type"); set => Accessor.SetUInt32("sdo_type", value); }


    public IProtobufRepeatedFieldValueType<ulong> KeyUint64 { get => new ProtobufRepeatedFieldValueType<ulong>(Accessor, "key_uint64"); }
