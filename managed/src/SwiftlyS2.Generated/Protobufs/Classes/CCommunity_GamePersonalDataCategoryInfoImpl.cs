...
internal class CCommunity_GamePersonalDataCategoryInfoImpl : TypedProtobuf<CCommunity_GamePersonalDataCategoryInfo>, CCommunity_GamePersonalDataCategoryInfo
{
    ...
    public string LocalizationToken { get => Accessor.GetString("localization_token"); set => Accessor.SetString("localization_token", value); }


    public string TemplateFile { get => Accessor.GetString("template_file"); set => Accessor.SetString("template_file", value); }
