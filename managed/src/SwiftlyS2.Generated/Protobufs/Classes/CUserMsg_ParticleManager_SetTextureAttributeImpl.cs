...
internal class CUserMsg_ParticleManager_SetTextureAttributeImpl : TypedProtobuf<CUserMsg_ParticleManager_SetTextureAttribute>, CUserMsg_ParticleManager_SetTextureAttribute
{
    ...
    public string AttributeName { get => Accessor.GetString("attribute_name"); set => Accessor.SetString("attribute_name", value); }


    public string TextureName { get => Accessor.GetString("texture_name"); set => Accessor.SetString("texture_name", value); }
