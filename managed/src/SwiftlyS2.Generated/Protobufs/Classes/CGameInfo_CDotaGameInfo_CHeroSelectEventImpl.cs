...
internal class CGameInfo_CDotaGameInfo_CHeroSelectEventImpl : TypedProtobuf<CGameInfo_CDotaGameInfo_CHeroSelectEvent>, CGameInfo_CDotaGameInfo_CHeroSelectEvent
{
    ...
    public bool IsPick { get => Accessor.GetBool("is_pick"); set => Accessor.SetBool("is_pick", value); }


    public uint Team { get => Accessor.GetUInt32("team"); set => Accessor.SetUInt32("team", value); }


    public int HeroId { get => Accessor.GetInt32("hero_id"); set => Accessor.SetInt32("hero_id", value); }
