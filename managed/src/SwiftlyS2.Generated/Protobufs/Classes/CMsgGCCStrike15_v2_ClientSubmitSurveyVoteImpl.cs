...
internal class CMsgGCCStrike15_v2_ClientSubmitSurveyVoteImpl : TypedProtobuf<CMsgGCCStrike15_v2_ClientSubmitSurveyVote>, CMsgGCCStrike15_v2_ClientSubmitSurveyVote
{
    ...
    public uint SurveyId { get => Accessor.GetUInt32("survey_id"); set => Accessor.SetUInt32("survey_id", value); }


    public uint Vote { get => Accessor.GetUInt32("vote"); set => Accessor.SetUInt32("vote", value); }
