...
internal class CGameServers_AggregationQuery_RequestImpl : TypedProtobuf<CGameServers_AggregationQuery_Request>, CGameServers_AggregationQuery_Request
{
    ...
    public string Filter { get => Accessor.GetString("filter"); set => Accessor.SetString("filter", value); }


    public IProtobufRepeatedFieldValueType<string> GroupFields { get => new ProtobufRepeatedFieldValueType<string>(Accessor, "group_fields"); }
