...
internal class CUserMessageRequestDllStatusImpl : NetMessage<CUserMessageRequestDllStatus>, CUserMessageRequestDllStatus
{
    ...
    public string DllAction { get => Accessor.GetString("dll_action"); set => Accessor.SetString("dll_action", value); }


    public bool FullReport { get => Accessor.GetBool("full_report"); set => Accessor.SetBool("full_report", value); }
