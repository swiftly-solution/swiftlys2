...
internal class CCSUsrMsg_RoundBackupFilenamesImpl : NetMessage<CCSUsrMsg_RoundBackupFilenames>, CCSUsrMsg_RoundBackupFilenames
{
    ...
    public int Count { get => Accessor.GetInt32("count"); set => Accessor.SetInt32("count", value); }
    ...
    public string Nicename { get => Accessor.GetString("nicename"); set => Accessor.SetString("nicename", value); }
