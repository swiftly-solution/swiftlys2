...
internal class CSVCMsg_VoiceInitImpl : NetMessage<CSVCMsg_VoiceInit>, CSVCMsg_VoiceInit
{
    ...
    public int Quality { get => Accessor.GetInt32("quality"); set => Accessor.SetInt32("quality", value); }


    public string Codec { get => Accessor.GetString("codec"); set => Accessor.SetString("codec", value); }
