...
internal class CUserMsg_ParticleManager_AddModellistOverrideElementImpl : TypedProtobuf<CUserMsg_ParticleManager_AddModellistOverrideElement>, CUserMsg_ParticleManager_AddModellistOverrideElement
{
    ...
    public string ModelName { get => Accessor.GetString("model_name"); set => Accessor.SetString("model_name", value); }


    public float SpawnProbability { get => Accessor.GetFloat("spawn_probability"); set => Accessor.SetFloat("spawn_probability", value); }
