...
internal class CUserMsg_ParticleManager_SetMaterialOverrideImpl : TypedProtobuf<CUserMsg_ParticleManager_SetMaterialOverride>, CUserMsg_ParticleManager_SetMaterialOverride
{
    ...
    public string MaterialName { get => Accessor.GetString("material_name"); set => Accessor.SetString("material_name", value); }


    public bool IncludeChildren { get => Accessor.GetBool("include_children"); set => Accessor.SetBool("include_children", value); }
