...
internal class CCSUsrMsg_ItemDropImpl : NetMessage<CCSUsrMsg_ItemDrop>, CCSUsrMsg_ItemDrop
{
    ...
    public long Itemid { get => Accessor.GetInt64("itemid"); set => Accessor.SetInt64("itemid", value); }


    public bool Death { get => Accessor.GetBool("death"); set => Accessor.SetBool("death", value); }
