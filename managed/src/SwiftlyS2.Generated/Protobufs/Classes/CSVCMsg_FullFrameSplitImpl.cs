...
internal class CSVCMsg_FullFrameSplitImpl : NetMessage<CSVCMsg_FullFrameSplit>, CSVCMsg_FullFrameSplit
{
    ...
    public int Section { get => Accessor.GetInt32("section"); set => Accessor.SetInt32("section", value); }


    public int Total { get => Accessor.GetInt32("total"); set => Accessor.SetInt32("total", value); }
