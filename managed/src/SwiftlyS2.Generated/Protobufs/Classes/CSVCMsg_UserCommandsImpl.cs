...
internal class CSVCMsg_UserCommandsImpl : TypedProtobuf<CSVCMsg_UserCommands>, CSVCMsg_UserCommands
{
    ...
    public IProtobufRepeatedFieldSubMessageType<CMsgServerUserCmd> Commands { get => new ProtobufRepeatedFieldSubMessageType<CMsgServerUserCmd>(Accessor, "commands"); }
