...
internal class EventHostageRescuedImpl : GameEvent<EventHostageRescued>, EventHostageRescued
{
    ...
    public short Hostage { get => (short)Accessor.GetInt32("hostage"); set => Accessor.SetInt32("hostage", value); }

    // rescue site index
    public short Site { get => (short)Accessor.GetInt32("site"); set => Accessor.SetInt32("site", value); }
}
