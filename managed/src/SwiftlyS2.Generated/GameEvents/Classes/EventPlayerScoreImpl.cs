...
internal class EventPlayerScoreImpl : GameEvent<EventPlayerScore>, EventPlayerScore
{
    ...
    // # of kills
    public short Kills { get => (short)Accessor.GetInt32("kills"); set => Accessor.SetInt32("kills", value); }

    // # of deaths
    public short Deaths { get => (short)Accessor.GetInt32("deaths"); set => Accessor.SetInt32("deaths", value); }

    // total game score
    public short Score { get => (short)Accessor.GetInt32("score"); set => Accessor.SetInt32("score", value); }
}
