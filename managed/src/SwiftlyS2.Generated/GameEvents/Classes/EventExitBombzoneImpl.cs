...
internal class EventExitBombzoneImpl : GameEvent<EventExitBombzone>, EventExitBombzone
{
    ...
    public bool HasBomb { get => Accessor.GetBool("hasbomb"); set => Accessor.SetBool("hasbomb", value); }

    public bool IsPlanted { get => Accessor.GetBool("isplanted"); set => Accessor.SetBool("isplanted", value); }
}
