...
internal class EventStartVoteImpl : GameEvent<EventStartVote>, EventStartVote
{
    ...
    public byte Type { get => (byte)Accessor.GetInt32("type"); set => Accessor.SetInt32("type", value); }

    public short VoteParameter { get => (short)Accessor.GetInt32("vote_parameter"); set => Accessor.SetInt32("vote_parameter", value); }
}
