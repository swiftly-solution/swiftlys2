...
internal class EventItemPurchaseImpl : GameEvent<EventItemPurchase>, EventItemPurchase
{
    ...
    public short Team { get => (short)Accessor.GetInt32("team"); set => Accessor.SetInt32("team", value); }

    public short LoadOut { get => (short)Accessor.GetInt32("loadout"); set => Accessor.SetInt32("loadout", value); }
