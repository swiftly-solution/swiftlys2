...
internal class EventSeasoncoinLevelupImpl : GameEvent<EventSeasoncoinLevelup>, EventSeasoncoinLevelup
{
    ...
    public short Category { get => (short)Accessor.GetInt32("category"); set => Accessor.SetInt32("category", value); }

    public short Rank { get => (short)Accessor.GetInt32("rank"); set => Accessor.SetInt32("rank", value); }
}
