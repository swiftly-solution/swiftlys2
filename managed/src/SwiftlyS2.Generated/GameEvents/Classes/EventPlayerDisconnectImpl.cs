...
internal class EventPlayerDisconnectImpl : GameEvent<EventPlayerDisconnect>, EventPlayerDisconnect
{
    ...
    public string NetworkID { get => Accessor.GetString("networkid"); set => Accessor.SetString("networkid", value); }

    // steam id
    public ulong XuID { get => Accessor.GetUInt64("xuid"); set => Accessor.SetUInt64("xuid", value); }

    public short PlayerID { get => (short)Accessor.GetInt32("PlayerID"); set => Accessor.SetInt32("PlayerID", value); }
}
