...
internal class EventPlayerChangenameImpl : GameEvent<EventPlayerChangename>, EventPlayerChangename
{
    ...
    public string OldName { get => Accessor.GetString("oldname"); set => Accessor.SetString("oldname", value); }

    // players new name
    public string NewName { get => Accessor.GetString("newname"); set => Accessor.SetString("newname", value); }
}
