...
internal class EventPlayerTeamImpl : GameEvent<EventPlayerTeam>, EventPlayerTeam
{
    ...
    // old team id
    public byte OldTeam { get => (byte)Accessor.GetInt32("oldteam"); set => Accessor.SetInt32("oldteam", value); }

    // team change because player disconnects
    public bool Disconnect { get => Accessor.GetBool("disconnect"); set => Accessor.SetBool("disconnect", value); }

    public bool Silent { get => Accessor.GetBool("silent"); set => Accessor.SetBool("silent", value); }
