...
internal class EventDroneDispatchedImpl : GameEvent<EventDroneDispatched>, EventDroneDispatched
{
    ...
    public short Priority { get => (short)Accessor.GetInt32("priority"); set => Accessor.SetInt32("priority", value); }

    public short DroneDispatched { get => (short)Accessor.GetInt32("drone_dispatched"); set => Accessor.SetInt32("drone_dispatched", value); }
}
