...
internal class EventEntityVisibleImpl : GameEvent<EventEntityVisible>, EventEntityVisible
{
    ...
    public int Subject { get => Accessor.GetInt32("subject"); set => Accessor.SetInt32("subject", value); }

    // Classname of the entity they see
    public string ClassName { get => Accessor.GetString("classname"); set => Accessor.SetString("classname", value); }

    // name of the entity they see
    public string EntityName { get => Accessor.GetString("entityname"); set => Accessor.SetString("entityname", value); }
}
