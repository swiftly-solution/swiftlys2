...
internal class EventInstructorStartLessonImpl : GameEvent<EventInstructorStartLesson>, EventInstructorStartLesson
{
    ...
    public byte VrMovementType { get => (byte)Accessor.GetInt32("vr_movement_type"); set => Accessor.SetInt32("vr_movement_type", value); }

    public bool VrSingleController { get => Accessor.GetBool("vr_single_controller"); set => Accessor.SetBool("vr_single_controller", value); }

    public byte VrControllerType { get => (byte)Accessor.GetInt32("vr_controller_type"); set => Accessor.SetInt32("vr_controller_type", value); }
}
