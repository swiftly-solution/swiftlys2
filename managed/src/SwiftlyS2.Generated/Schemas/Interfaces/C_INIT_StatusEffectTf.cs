...
public partial interface C_INIT_StatusEffectTf : CParticleFunctionInitializer, ISchemaClass<C_INIT_StatusEffectTf>
{
    static C_INIT_StatusEffectTf ISchemaClass<C_INIT_StatusEffectTf>.From(nint handle) => new C_INIT_StatusEffectTfImpl(handle);
    static int ISchemaClass<C_INIT_StatusEffectTf>.Size => 568;
    static string? ISchemaClass<C_INIT_StatusEffectTf>.ClassName => null;
    ...
    public ref float SFXEnvMapAmount { get; }
