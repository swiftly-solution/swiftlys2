...
internal static class ClassConvertor
{
    ...
    [
        ...
        "sky_camera",
        "sky_camera_volume",
        "sky_camera_volume_target",
        "skybox_reference",
        "smokegrenade_projectile",
        "snd_event_alignedbox",
        "snd_event_box_helper",
        "snd_event_cone",
        "snd_event_multipoint",
        "snd_event_oriented_boxes",
    ...
    public static CEntityInstance ConvertEntityByDesignerName( nint address, string designerName )
    {
        return designerName switch
        {
            ...
            "base_clientui_entity" => new CBaseClientUIEntityImpl(address),
            "base_combat_character" => new CBaseCombatCharacterImpl(address),
            "base_plat_train" => new CBasePlatTrainImpl(address),
            "base_player_weapon" => new CBasePlayerWeaponImpl(address),
            "base_prop" => new CBasePropImpl(address),
            "base_prop_door" => new CBasePropDoorImpl(address),
            "base_toggle" => new CBaseToggleImpl(address),
            ...
            "breakable_prop" => new CBreakablePropImpl(address),
            "broken_glass_trap" => new CBrokenGlassTrapImpl(address),
            ...
            "cs_minimap_volume" => new CCSMinimapVolumeImpl(address),
            ...
            "custom_player_camera" => new CCSCustomPlayerCameraImpl(address),
            ...
            "logic_playerproxy" => new CGenericLogicPlayerProxyImpl(address),
            "logic_playerproxy_base" => new CLogicPlayerProxyBaseImpl(address),
            ...
            "markup_volume_tagged_base" => new CMarkupVolumeTaggedImpl(address),
            ...
            "observable_element" => new CCSObservableElementImpl(address),
            ...
            "phys_constraint_base" => new CPhysConstraintImpl(address),
            "phys_force" => new CPhysForceImpl(address),
            ...
            "prop_door_rotating_base" => new CPropDoorRotatingImpl(address),
            ...
            "radar_element" => new CCSRadarElementImpl(address),
            "root" => new CEntityInstanceImpl(address),
            "rotator_target" => new CRotatorTargetImpl(address),
            "rule_entity" => new CRuleEntityImpl(address),
            "rule_point_entity" => new CRulePointEntityImpl(address),
            "rush_intro_counterterrorist" => new CCSGO_RushIntroCounterTerroristPositionImpl(address),
            "rush_intro_terrorist" => new CCSGO_RushIntroTerroristPositionImpl(address),
            ...
            "sky_camera_volume" => new CSkyCameraVolumeImpl(address),
            "sky_camera_volume_target" => new CSkyCameraVolumeTargetImpl(address),
            ...
            "snd_event_box_helper" => new CSoundEventBoxHelperImpl(address),
            "snd_event_cone" => new CSoundEventConeEntityImpl(address),
            "snd_event_multipoint" => new CSoundEventMultiPointEntityImpl(address),
            "snd_event_oriented_boxes" => new CSoundEventBoxEntityImpl(address),
            ...
            "snd_opvar_set_dome" => new CSoundOpvarSetDomeEntityImpl(address),
