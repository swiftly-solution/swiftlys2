...
public struct SteamDatagramRelayAuthTicket
{
    ...
    private readonly uint m_unPublicIP;
    ...
    private readonly uint m_nAppID;
    ...
    private readonly int m_nRestrictToVirtualPort;
    ...
    private struct ExtraField
    {
        ...
        private readonly EType m_eType;

        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 28)]
        private readonly byte[] m_szName;
        ...
        private struct OptionValue
        {
            ...
            private readonly byte[] m_szStringValue;

            [FieldOffset(0)]
            private readonly long m_nIntValue;

            [FieldOffset(0)]
            private readonly ulong m_nFixed64Value;
        }
    ...
    private readonly int m_nExtraFields;

    [MarshalAs(UnmanagedType.ByValArray, SizeConst = k_nMaxExtraFields)]
    private readonly ExtraField[] m_vecExtraFields;
