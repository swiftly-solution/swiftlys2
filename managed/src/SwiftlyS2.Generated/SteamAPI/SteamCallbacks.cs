...
public struct AppProofOfPurchaseKeyResponse_t
{
    ...
    private readonly byte[] m_rgchKey_;
...
public struct GameServerChangeRequested_t
{
    ...
    private readonly byte[] m_rgchServer_;
    ...
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 64)]
    private readonly byte[] m_rgchPassword_;
...
public struct GameRichPresenceJoinRequested_t
{
    ...
    private readonly byte[] m_rgchConnect_;
...
public struct OverlayBrowserProtocolNavigation_t
{
    ...
    private readonly byte[] rgchURI_;
...
public struct GSClientDeny_t
{
    ...
    private readonly byte[] m_rgchOptionalText_;
...
public struct GSClientAchievementStatus_t
{
    ...
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 128)]
    private readonly byte[] m_pchAchievement_;
...
public struct SteamInventoryRequestPricesResult_t
{
    ...
    private readonly byte[] m_rgchCurrency_;
...
public struct JoinPartyCallback_t
{
    ...
    private readonly byte[] m_rgchConnectString_;
...
public struct SteamNetAuthenticationStatus_t
{
    ...
    /// purposes only.
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)]
    private readonly byte[] m_debugMsg_;
...
public struct SteamRemotePlayTogetherGuestInvite_t
{
    ...
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1024)]
    private readonly byte[] m_szConnectURL_;
...
public struct RemoteStorageFileShareResult_t
{
    ...
    private readonly byte[] m_rgchFilename_;
...
public struct RemoteStorageDownloadUGCResult_t
{
    ...
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = Constants.k_cchFilenameMax)]
    private readonly byte[] m_pchFileName_;
...
public struct RemoteStorageGetPublishedFileDetailsResult_t
{
    ...
    private readonly byte[] m_rgchTitle_;
    ...
    private readonly byte[] m_rgchDescription_;
    ...
    private readonly byte[] m_rgchTags_;
    ...
    private readonly byte[] m_rgchURL_;
...
public struct SteamTimelineGamePhaseRecordingExists_t
{
    ...
    private readonly byte[] m_rgchPhaseID_;
...
public struct SteamUGCQueryCompleted_t
{
    ...
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = Constants.k_cchPublishedFileURLMax)]
    private readonly byte[] m_rgchNextCursor_;
...
public struct GameWebCallback_t
{
    ...
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)]
    private readonly byte[] m_szURL_;
...
public struct UserAchievementStored_t
{
    ...
    private readonly byte[] m_rgchAchievementName_;
