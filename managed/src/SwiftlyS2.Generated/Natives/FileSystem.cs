...
internal static class NativeFileSystem
{
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, int, int, int > _GetSearchPath;
    ...
    public unsafe static string GetSearchPath( string pathId, int searchPathType, int searchPathsToGet )
    {
        ...
        _ = Encoding.UTF8.GetBytes(pathId, pathIdBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, int, int, void > _AddSearchPath;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, byte > _RemoveSearchPath;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, byte > _FileExists;
    ...
    public unsafe static bool FileExists( string fileName, string pathId )
    {
        ...
        _ = Encoding.UTF8.GetBytes(fileName, fileNameBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, byte > _IsDirectory;
    ...
    private static readonly unsafe delegate* unmanaged< void > _PrintSearchPaths;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, byte*, int > _ReadFile;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, byte*, byte > _WriteFile;
    ...
    public unsafe static bool WriteFile( string fileName, string pathId, string content )
    {
        ...
        _ = Encoding.UTF8.GetBytes(content, contentBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, uint > _GetFileSize;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, byte > _PrecacheFile;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, byte > _IsFileWritable;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, byte, byte > _SetFileWritable;
