...
{
    private static readonly unsafe delegate* unmanaged< nint > _AllocateHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint > _AllocateMHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _DeallocateHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _DeallocateVHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _DeallocateMHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, nint, nint, void > _SetHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, nint, int, nint, byte, void > _SetVHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, nint, nint, void > _SetMHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _EnableHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _EnableVHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _EnableMHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _DisableHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _DisableVHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _DisableMHook;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte > _IsHookEnabled;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte > _IsVHookEnabled;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte > _IsMHookEnabled;
    ...
    private static readonly unsafe delegate* unmanaged< nint, nint > _GetHookOriginal;
    ...
    private static readonly unsafe delegate* unmanaged< nint, nint > _GetVHookOriginal;
