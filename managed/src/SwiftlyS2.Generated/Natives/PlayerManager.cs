...
internal static class NativePlayerManager
{
    ...
    private static readonly unsafe delegate* unmanaged< int, byte > _IsPlayerOnline;
    ...
    private static readonly unsafe delegate* unmanaged< int > _GetPlayerCount;
    ...
    private static readonly unsafe delegate* unmanaged< int > _GetPlayerCap;
    ...
    private static readonly unsafe delegate* unmanaged< int, byte*, int, void > _SendMessage;
    ...
    private static readonly unsafe delegate* unmanaged< int, byte, void > _ShouldBlockTransmitEntity;
    ...
    private static readonly unsafe delegate* unmanaged< void > _ClearAllBlockedTransmitEntity;
