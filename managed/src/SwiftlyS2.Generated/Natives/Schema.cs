...
internal static class NativeSchema
{
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong, void > _SetStateChanged;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, uint > _FindChainOffset;
    ...
    private static readonly unsafe delegate* unmanaged< ulong, int > _GetOffset;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte > _IsStruct;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte > _IsClassLoaded;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong, nint > _GetPropPtr;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong, nint, uint, void > _WritePropPtr;
    ...
    private static readonly unsafe delegate* unmanaged< nint, nint > _GetVData;
