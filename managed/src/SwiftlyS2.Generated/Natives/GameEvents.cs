...
internal static class NativeGameEvents
{
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, int > _GetInt;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint > _GetPtr;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint > _GetEHandle;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint > _GetEntity;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, int > _GetEntityIndex;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, int > _GetPlayerSlot;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint > _GetPlayerController;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint > _GetPlayerPawn;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint > _GetPawnEHandle;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, int > _GetPawnEntityIndex;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, int, void > _SetInt;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, void > _SetPtr;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, void > _SetEntity;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, int, void > _SetEntityIndex;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, int, void > _SetPlayerSlot;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, byte > _HasKey;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte > _IsReliable;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte > _IsLocal;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, void > _RegisterListener;
    ...
    public unsafe static void RegisterListener( string eventName )
    {
        ...
        _ = Encoding.UTF8.GetBytes(eventName, eventNameBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong > _AddListenerPreCallback;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong > _AddListenerPostCallback;
    ...
    private static readonly unsafe delegate* unmanaged< ulong, void > _RemoveListenerPostCallback;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint > _CreateEvent;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _FreeEvent;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte, void > _FireEvent;
    ...
    private static readonly unsafe delegate* unmanaged< nint, int, void > _FireEventToClient;
    ...
    private static readonly unsafe delegate* unmanaged< int, byte*, byte > _IsPlayerListeningToEventName;
    ...
    private static readonly unsafe delegate* unmanaged< int, nint, byte > _IsPlayerListeningToEvent;
