...
internal static class NativeEngineHelpers
{
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int > _GetIP;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte > _IsMapValid;
    ...
    public unsafe static bool IsMapValid( string map_name )
    {
        ...
        _ = Encoding.UTF8.GetBytes(map_name, map_nameBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< byte*, void > _ExecuteCommand;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint > _FindGameSystemByName;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, void > _SendMessageToConsole;
    ...
    public unsafe static void SendMessageToConsole( string msg )
    {
        ...
        _ = Encoding.UTF8.GetBytes(msg, msgBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< nint > _GetTraceManager;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int > _GetCurrentGame;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int > _GetNativeVersion;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int > _GetMenuSettings;
    ...
    private static readonly unsafe delegate* unmanaged< nint > _GetGlobalVars;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int > _GetCSGODirectoryPath;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int > _GetGameDirectoryPath;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int > _GetWorkshopId;
