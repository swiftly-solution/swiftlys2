...
internal static class NativePlayer
{
    ...
    private static readonly unsafe delegate* unmanaged< int, int, byte*, int, void > _SendMessage;
    ...
    public unsafe static void SendMessage( int playerid, int kind, string message, int htmlDuration )
    {
        ...
        _ = Encoding.UTF8.GetBytes(message, messageBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< int, byte > _IsFakeClient;
    ...
    private static readonly unsafe delegate* unmanaged< int, byte > _IsAuthorized;
    ...
    private static readonly unsafe delegate* unmanaged< int, uint > _GetConnectedTime;
    ...
    private static readonly unsafe delegate* unmanaged< int, ulong > _GetUnauthorizedSteamID;
    ...
    private static readonly unsafe delegate* unmanaged< int, ulong > _GetSteamID;
    ...
    private static readonly unsafe delegate* unmanaged< int, nint > _GetController;
    ...
    private static readonly unsafe delegate* unmanaged< int, nint > _GetPawn;
    ...
    private static readonly unsafe delegate* unmanaged< int, nint > _GetPlayerPawn;
    ...
    private static readonly unsafe delegate* unmanaged< int, ulong > _GetPressedButtons;
    ...
    private static readonly unsafe delegate* unmanaged< int, byte*, void > _PerformCommand;
    ...
    public unsafe static void PerformCommand( int playerid, string command )
    {
        ...
        _ = Encoding.UTF8.GetBytes(command, commandBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, int > _GetIPAddress;
    ...
    private static readonly unsafe delegate* unmanaged< int, byte*, int, void > _Kick;
    ...
    public unsafe static void Kick( int playerid, string reason, int gamereason )
    {
        ...
        _ = Encoding.UTF8.GetBytes(reason, reasonBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< int, int, byte, void > _ShouldBlockTransmitEntity;
    ...
    private static readonly unsafe delegate* unmanaged< int, int, byte > _IsTransmitEntityBlocked;
    ...
    private static readonly unsafe delegate* unmanaged< int, void > _ClearTransmitEntityBlocked;
    ...
    private static readonly unsafe delegate* unmanaged< int, int, void > _ChangeTeam;
    ...
    private static readonly unsafe delegate* unmanaged< int, int, void > _SwitchTeam;
    ...
    private static readonly unsafe delegate* unmanaged< int, nint, void > _TakeDamage;
    ...
    private static readonly unsafe delegate* unmanaged< int, Vector, QAngle, Vector, void > _Teleport;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, int > _GetLanguage;
    ...
    private static readonly unsafe delegate* unmanaged< int, byte*, void > _SetCenterMenuRender;
    ...
    private static readonly unsafe delegate* unmanaged< int, void > _ClearCenterMenuRender;
    ...
    private static readonly unsafe delegate* unmanaged< int, byte > _HasMenuShown;
    ...
    private static readonly unsafe delegate* unmanaged< int, byte*, void > _ExecuteCommand;
