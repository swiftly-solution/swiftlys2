...
internal static class NativeCEntityKeyValues
{
    ...
    private static readonly unsafe delegate* unmanaged< nint > _Allocate;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _Deallocate;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, uint > _GetUint;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, CUtlStringToken > _GetStringToken;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, Vector4D > _GetVector4D;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, uint, void > _SetUint;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, CUtlStringToken, void > _SetStringToken;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, Vector4D, void > _SetVector4D;
