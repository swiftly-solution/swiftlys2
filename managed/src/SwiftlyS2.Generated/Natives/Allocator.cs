...
internal static class NativeAllocator
{
    ...
    private static readonly unsafe delegate* unmanaged< ulong, nint > _Alloc;
    ...
    private static readonly unsafe delegate* unmanaged< ulong, byte*, byte*, nint > _TrackedAlloc;
    ...
    public unsafe static nint TrackedAlloc( ulong size, string identifier, string details )
    {
        ...
        _ = Encoding.UTF8.GetBytes(identifier, identifierBuffer);
        ...
        _ = Encoding.UTF8.GetBytes(details, detailsBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _Free;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong, nint > _Resize;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong > _GetSize;
    ...
    private static readonly unsafe delegate* unmanaged< ulong > _GetTotalAllocated;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, ulong > _GetAllocatedByTrackedIdentifier;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte > _IsPointerValid;
    ...
    private static readonly unsafe delegate* unmanaged< nint, nint, ulong, void > _Copy;
    ...
    private static readonly unsafe delegate* unmanaged< nint, nint, ulong, void > _Move;
