...
internal static class NativeEntitySystem
{
    ...
    private static readonly unsafe delegate* unmanaged< nint, nint, void > _Spawn;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _Despawn;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint > _CreateEntityByName;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, int, int, void > _AcceptInputInt32;
    ...
    public unsafe static void AcceptInputInt32( nint entity, string input, nint activator, nint caller, int value, int outputID )
    {
        ...
        _ = Encoding.UTF8.GetBytes(input, inputBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, uint, int, void > _AcceptInputUInt32;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, long, int, void > _AcceptInputInt64;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, ulong, int, void > _AcceptInputUInt64;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, float, int, void > _AcceptInputFloat;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, double, int, void > _AcceptInputDouble;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, byte, int, void > _AcceptInputBool;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, byte*, int, void > _AcceptInputString;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, int, float, void > _AddEntityIOEventInt32;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, uint, float, void > _AddEntityIOEventUInt32;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, long, float, void > _AddEntityIOEventInt64;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, ulong, float, void > _AddEntityIOEventUInt64;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, float, float, void > _AddEntityIOEventFloat;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, double, float, void > _AddEntityIOEventDouble;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, byte, float, void > _AddEntityIOEventBool;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, nint, nint, byte*, float, void > _AddEntityIOEventString;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte > _IsValidEntity;
    ...
    private static readonly unsafe delegate* unmanaged< nint > _GetGameRules;
    ...
    private static readonly unsafe delegate* unmanaged< nint > _GetEntitySystem;
    ...
    private static readonly unsafe delegate* unmanaged< uint, byte > _EntityHandleIsValid;
    ...
    private static readonly unsafe delegate* unmanaged< uint, nint > _EntityHandleGet;
    ...
    private static readonly unsafe delegate* unmanaged< nint, uint > _GetEntityHandleFromEntity;
    ...
    private static readonly unsafe delegate* unmanaged< nint > _GetFirstActiveEntity;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, nint, ulong > _HookEntityOutput;
    ...
    public unsafe static ulong HookEntityOutput( string className, string outputName, nint callback )
    {
        ...
        _ = Encoding.UTF8.GetBytes(className, classNameBuffer);
        ...
        _ = Encoding.UTF8.GetBytes(outputName, outputNameBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< ulong, void > _UnhookEntityOutput;
    ...
    private static readonly unsafe delegate* unmanaged< uint, nint > _GetEntityByIndex;
