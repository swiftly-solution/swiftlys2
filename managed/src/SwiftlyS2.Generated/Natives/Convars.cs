...
internal static class NativeConvars
{
    ...
    private static readonly unsafe delegate* unmanaged< int, byte*, void > _QueryClientConvar;
    ...
    public unsafe static void QueryClientConvar( int playerid, string cvarName )
    {
        ...
        _ = Encoding.UTF8.GetBytes(cvarName, cvarNameBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< nint, int > _AddQueryClientCvarCallback;
    ...
    private static readonly unsafe delegate* unmanaged< int, void > _RemoveQueryClientCvarCallback;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong > _AddGlobalChangeListener;
    ...
    private static readonly unsafe delegate* unmanaged< ulong, void > _RemoveGlobalChangeListener;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong > _AddConvarCreatedListener;
    ...
    private static readonly unsafe delegate* unmanaged< ulong, void > _RemoveConvarCreatedListener;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong > _AddConCommandCreatedListener;
    ...
    private static readonly unsafe delegate* unmanaged< ulong, void > _RemoveConCommandCreatedListener;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, short, nint, nint, void > _CreateConvarInt16;
    ...
    public unsafe static void CreateConvarInt16( string cvarName, int cvarType, ulong cvarFlags, string helpMessage, short defaultValue, nint minValue, nint maxValue )
    {
        ...
        _ = Encoding.UTF8.GetBytes(helpMessage, helpMessageBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, ushort, nint, nint, void > _CreateConvarUInt16;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, int, nint, nint, void > _CreateConvarInt32;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, uint, nint, nint, void > _CreateConvarUInt32;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, long, nint, nint, void > _CreateConvarInt64;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, ulong, nint, nint, void > _CreateConvarUInt64;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, byte, nint, nint, void > _CreateConvarBool;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, float, nint, nint, void > _CreateConvarFloat;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, double, nint, nint, void > _CreateConvarDouble;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, Color, nint, nint, void > _CreateConvarColor;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, Vector2D, nint, nint, void > _CreateConvarVector2D;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, Vector, nint, nint, void > _CreateConvarVector;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, Vector4D, nint, nint, void > _CreateConvarVector4D;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, QAngle, nint, nint, void > _CreateConvarQAngle;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int, ulong, byte*, byte*, nint, nint, void > _CreateConvarString;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, void > _DeleteConvar;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte > _ExistsConvar;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, int > _GetConvarType;
    ...
    private static readonly unsafe delegate* unmanaged< int, byte*, byte*, void > _SetClientConvarValueString;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, ulong > _GetFlags;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, ulong, void > _SetFlags;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint > _GetMinValuePtrPtr;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint > _GetMaxValuePtrPtr;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte > _HasDefaultValue;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint > _GetDefaultValuePtr;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint, void > _SetDefaultValue;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, void > _SetDefaultValueString;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint > _GetValuePtr;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint, void > _SetValuePtr;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint, void > _SetValueInternalPtr;
