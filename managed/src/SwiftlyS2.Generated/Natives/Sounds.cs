...
internal static class NativeSounds
{
    ...
    private static readonly unsafe delegate* unmanaged< nint > _CreateSoundEvent;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _DestroySoundEvent;
    ...
    private static readonly unsafe delegate* unmanaged< nint, uint > _Emit;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, void > _SetName;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint, int > _GetName;
    ...
    private static readonly unsafe delegate* unmanaged< nint, int, void > _SetSourceEntityIndex;
    ...
    private static readonly unsafe delegate* unmanaged< nint, int > _GetSourceEntityIndex;
    ...
    private static readonly unsafe delegate* unmanaged< nint, int, void > _AddClient;
    ...
    private static readonly unsafe delegate* unmanaged< nint, int, void > _RemoveClient;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _ClearClients;
    ...
    private static readonly unsafe delegate* unmanaged< nint, void > _AddAllClients;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, Vector, void > _SetFloat3;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, Vector > _GetFloat3;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong > _GetClients;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong, void > _SetClients;
