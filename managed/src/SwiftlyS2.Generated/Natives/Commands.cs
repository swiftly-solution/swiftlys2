...
internal static class NativeCommands
{
    ...
    private static readonly unsafe delegate* unmanaged< int, byte*, int > _HandleCommandForPlayer;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint, byte, ulong > _RegisterCommand;
    ...
    public unsafe static ulong RegisterCommand( string commandName, nint callback, bool registerRaw )
    {
        ...
        _ = Encoding.UTF8.GetBytes(commandName, commandNameBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< ulong, void > _UnregisterCommand;
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, byte, ulong > _RegisterAlias;
    ...
    public unsafe static ulong RegisterAlias( string aliasName, string commandName, bool registerRaw )
    {
        ...
        _ = Encoding.UTF8.GetBytes(aliasName, aliasNameBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< ulong, void > _UnregisterAlias;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong > _RegisterClientCommandsListener;
    ...
    private static readonly unsafe delegate* unmanaged< nint, ulong > _RegisterClientChatListener;
    ...
    private static readonly unsafe delegate* unmanaged< ulong, void > _UnregisterClientChatListener;
