...
internal static class NativeMemoryHelpers
{
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint > _FetchInterfaceByName;
    ...
    public unsafe static nint FetchInterfaceByName( string ifaceName )
    {
        ...
        _ = Encoding.UTF8.GetBytes(ifaceName, ifaceNameBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, nint > _GetVirtualTableAddress;
    ...
    public unsafe static nint GetVirtualTableAddress( string library, string vtableName )
    {
        ...
        _ = Encoding.UTF8.GetBytes(library, libraryBuffer);
        ...
        _ = Encoding.UTF8.GetBytes(vtableName, vtableNameBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< byte*, byte*, int, byte, nint > _GetAddressBySignature;
    ...
    public unsafe static nint GetAddressBySignature( string library, string sig, int len, bool rawBytes )
    {
        ...
        _ = Encoding.UTF8.GetBytes(sig, sigBuffer);
    ...
    private static readonly unsafe delegate* unmanaged< byte*, nint, int > _GetObjectPtrVtableName;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte > _ObjectPtrHasVtable;
    ...
    private static readonly unsafe delegate* unmanaged< nint, byte*, byte > _ObjectPtrHasBaseClass;
    ...
    public unsafe static bool ObjectPtrHasBaseClass( nint objptr, string baseClassName )
    {
        ...
        _ = Encoding.UTF8.GetBytes(baseClassName, baseClassNameBuffer);
