...
public interface INetMessageService
{
    ...
    public delegate HookResult ServerNetMessageHandler<T>( T msg ) where T : ITypedProtobuf<T>, INetMessage<T>, IDisposable;
    ...
    /// <returns>The hook result.</returns>
    public delegate HookResult ClientNetMessageHandler<T>( T msg, int playerId ) where T : ITypedProtobuf<T>, INetMessage<T>, IDisposable;
